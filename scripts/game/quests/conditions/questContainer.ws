...
class W3QuestCond_Container extends CQuestScriptedCondition
{
	...
	function Deactivate()
	{
		...
		// W3EE - Begin
		if( theGame.questInventoryComponents.Contains( inventory ) )
		{
			theGame.questInventoryComponents.Remove( inventory );
		}
		// W3EE - End
	...
	function FindInventory()
	{
		...
		for( i = 0; i < entities.Size(); i+=1 )
		{
			...
			{		
				...
				{
					// W3EE - Begin
					theGame.questInventoryComponents.PushBack(inventory);
					// W3EE - End
					break;
				}
			}
