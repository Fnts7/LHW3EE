...
import class W3Container extends W3LockableEntity 
{
	...
	// W3EE - Begin
	public function IsSpecialContainer() : bool
	{
		return (focusModeHighlight == FMV_Clue || factOnContainerOpened != "" || IsLocked() || isDynamic);
	}
	// W3EE - End
	...
	public final function ShowLoot()
	{
		...
		if( (W3Herb)this )
		{
			GetWitcherPlayer().GetAnimManager().PerformLootingAnimation(this);
			return;
		}
		// W3EE - End
