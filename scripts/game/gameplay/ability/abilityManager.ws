...
/*		if ( stat == CPS_Spellpower )
	...
	// W3EE - Begin
	public final function DrainFocus(amount : float, optional dt : float, optional isUndyingCall : bool )
	{		
		if ( dt > 0 )
			InternalReduceStat(BCS_Focus, amount * dt);
		else InternalReduceStat(BCS_Focus, amount);
		OnFocusChanged(isUndyingCall);
	}
	// W3EE - End
	...
	// W3EE - Begin
	protected function OnFocusChanged( optional isUndyingCall : bool );
	// W3EE - End
