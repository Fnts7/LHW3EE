...
{	
	...
	function OnAnimEvent( animEventName : name, animEventType : EAnimationEventType, animInfo : SAnimationEventAnimInfo ) : bool
	{
		...
		{
			npc = GetNPC();
			npc.npcStats.damageValue *= 0.75f;
			npc.npcStats.armorPiercing = 0.5f;
			npc.npcStats.poiseValue = 0.75f;
			npc.npcStats.physicalResist	= 0.5f;
			npc.npcStats.forceResist = 0.25f;
			npc.npcStats.fireResist = 0.4f;
			npc.npcStats.slowResist = 0.25f;
			npc.npcStats.bleedingResist = 0.4f;
			npc.npcStats.poisonResist = 0.3f;			
			
			npc.npcStats.spdMultID = npc.SetAnimationSpeedMultiplier(0.85f, npc.npcStats.spdMultID);
			
			npc.SignalGameplayEvent( 'LeaveCurrentCombatStyle' );
			return true;
		}
