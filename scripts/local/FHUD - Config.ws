...
class CModFriendlyHUDConfig
{
	...
	public var markerMinDistance : float;
	public var markerMaxDistance : float;
	...
	public function UpdateUserSettings()
	{
		...
		markerMinDistance = StringToInt(theGame.GetInGameConfigWrapper().GetVarValue('fhudMarkers', 'fhudMarkerMinDistance'));
		markerMaxDistance = StringToInt(theGame.GetInGameConfigWrapper().GetVarValue('fhudMarkers', 'fhudMarkerMaxDistance'));
	...
	public function ShowNPCName(target : CNewNPC) : bool
	{
		...
		if( maxDistanceToShowNames > 0 && VecDistance(thePlayer.GetWorldPosition(), target.GetWorldPosition()) > maxDistanceToShowNames )
		{
			return false;
		}
		return true;
