...
{	
	...
	private var quickMenuType			: int;
	
	private var alchemyYield			: int;
	...
	public function ReadOptionValues()
	{
		...
		quickMenuType = StringToInt(wrapper.GetVarValue('SCOptionPrepMed', 'PrepMenu'));
		
		alchemyYield = StringToInt(wrapper.GetVarValue('SCOptionPrepAlch', 'cooked_quantity'));
	...
	// ---- Meditation Start ---- //
		...
		public function GetQuickMenuType() : int
		{
			return quickMenuType;
		}
	...
	// ---- Alchemy Start ---- //
		...
		public function GetAlchemyYield() : int
		{
			return alchemyYield;
		}
	...
	public function QuestGoldMult() : float
	{
		return StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('SCOptionE', 'GoldMult') );
	}	
	...
	public function SprintInWitcherSense() : bool
	{
		return theGame.GetInGameConfigWrapper().GetVarValue('SCOptionEx', 'SStamWitSen');
	}	
	...
	public function CityGallop() : bool
	{
		return theGame.GetInGameConfigWrapper().GetVarValue('SCOptionEx', 'HorseSprinting');
	}		
	...
	{
		return ( StringToFloat(theGame.GetInGameConfigWrapper().GetVarValue('SCOptionSkills', 'VersionNr')) == 3.07 );
	}
	...
	public final function FirstTimeOptionSetup()
	{
		...
		// ---- Version Number Begin ---- //
			...
			wrapper.SetVarValue('SCOptionSkills', 'VersionNr', "3.07");
		...
		// ---- Experience Begin ---- //
			...
			wrapper.SetVarValue('SCOptionE', 'GoldMult', "1.0");
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
			...
			wrapper.SetVarValue('SCOptionCW', 'ASC', "0");
			wrapper.SetVarValue('SCOptionCW', 'ASCL', "0");
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
			...
			wrapper.SetVarValue('SCOptionCP', 'CTHH', "1");
			wrapper.SetVarValue('SCOptionCP', 'CTHSH', "2");
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
			...
			wrapper.SetVarValue('SCOptionCA', 'ADRGenD', "2.5");
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
			...
			wrapper.SetVarValue('SCOptionRend', 'ReDPS', "2");
		...
		// ---- Enemies Start ---- //
			...
			wrapper.SetVarValue('SCOptionCE1', 'BlockHits2', "50");
			...
			wrapper.SetVarValue('SCOptionCE2', 'BlockHits2', "50");
			wrapper.SetVarValue('SCOptionCE2', 'BlockHits3', "15");
			wrapper.SetVarValue('SCOptionCE2', 'BlockHits4', "10");
			wrapper.SetVarValue('SCOptionCE2', 'BlockHits5', "80");
			...
			wrapper.SetVarValue('SCOptionCE2', 'BlockHits11', "20");
			wrapper.SetVarValue('SCOptionCE2', 'BlockHits12', "20");
			
			// GROUP 3 Adept
			wrapper.SetVarValue('SCOptionCE3', 'BlockHits1', "0");
			wrapper.SetVarValue('SCOptionCE3', 'BlockHits2', "60");
			wrapper.SetVarValue('SCOptionCE3', 'BlockHits3', "5");
			wrapper.SetVarValue('SCOptionCE3', 'BlockHits4', "20");
			wrapper.SetVarValue('SCOptionCE3', 'BlockHits5', "90");
			...
			wrapper.SetVarValue('SCOptionCE4', 'BlockHits3', "0");
			wrapper.SetVarValue('SCOptionCE4', 'BlockHits4', "40");
			wrapper.SetVarValue('SCOptionCE4', 'BlockHits5', "90");
			...
			wrapper.SetVarValue('SCOptionCE5', 'BlockHits5', "95");
			...
			wrapper.SetVarValue('SCOptionEx', 'SStamDelExpl', "3");	
			wrapper.SetVarValue('SCOptionEx', 'SStamDelComb', "2");	
			wrapper.SetVarValue('SCOptionEx', 'SStamInstDr', false);
			wrapper.SetVarValue('SCOptionEx', 'SStamWitSen', true);	
			wrapper.SetVarValue('SCOptionEx', 'SStamIndoor', false);
			wrapper.SetVarValue('SCOptionEx', 'HorseSprinting', true);			
	...
	private function OptionSetupPart2()
	{
		...
		wrapper = theGame.GetInGameConfigWrapper();
			...
			wrapper.SetVarValue('SCOptionPrepAlch', 'cooked_quantity', "1");
			...
			wrapper.SetVarValue('SCOptionPrepAlch', 'global_mininum_potion_duration', "240");
			...
			wrapper.SetVarValue('fhudQuickItems', 'fhudDefaultDisplayMode', "0");
			...
			wrapper.SetVarValue('LFEcat', 'LFEcatBoots', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatGloves', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatTrophy', "0.5");
			wrapper.SetVarValue('LFEcat', 'LFEcatHorseBag', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatFood', "0.25");
			wrapper.SetVarValue('LFEcat', 'LFEcatPotion', "0.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatBomb', "0.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatUse', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatDye', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatTool', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatOil', "0.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatMisc', "0.2");
			wrapper.SetVarValue('LFEcat', 'LFEcatJunk', "0.1");
			wrapper.SetVarValue('LFEcat', 'LFEcatBook', "0.5");
			wrapper.SetVarValue('LFEcat', 'LFEcatUpgrade', "1");
			wrapper.SetVarValue('LFEcat', 'LFEcatCraft', "1.0");
			wrapper.SetVarValue('LFEcat', 'LFEcatAlchemy', "0.35");
			...
			wrapper.SetVarValue('LFEdur', 'LFEdur50', "0.0");
			wrapper.SetVarValue('LFEdur', 'LFEdur75', "0.75");
			wrapper.SetVarValue('LFEdur', 'LFEdur90', "0.9");
			wrapper.SetVarValue('LFEdur', 'LFEdur100', "0.95");
			// ---- Durability Prices End ---- //
			
			
			// ---- Misc Prices Begin ---- //
			wrapper.SetVarValue('LFEsb', 'LFEsbSell', "0.5");
			wrapper.SetVarValue('LFEsb', 'LFEsbBuy', "1");
			wrapper.SetVarValue('LFEmisc', 'LFEgold', "1.0");
			wrapper.SetVarValue('LFEmisc', 'LFEcraftPrice', "1");
			wrapper.SetVarValue('LFEmisc', 'LFEdialog', "0.3");
			wrapper.SetVarValue('LFEmisc', 'LFErepair', "1.0");
			wrapper.SetVarValue('LFEmisc', 'LFEremup', "1.0");
			wrapper.SetVarValue('LFEmisc', 'LFEdiss', "1.0");
...
exec function functest()
{
	...
	temp = EffectTypeToName(EET_Mutation10);
	temp2 = EffectTypeToName(EET_ReflexBlast);
}